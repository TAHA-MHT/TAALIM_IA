...
class Exercise {
  final String type; // 'qcm', 'qcm_image', 'match', 'match_lang'
  final String? qFr;
  final String? qAr;
  final String? qEmoji;
...
const List<Subject> subjects = [
  ...
  Subject(key: 'ecriture', emoji: '✏️', nameFr: 'Écriture', nameAr: 'الكتابة', color: AppColors.ecriture, colorSoft: AppColors.ecritureSoft, available: false),
];
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: (ex.type == 'qcm' || ex.type == 'qcm_image') ? _buildQcm(ex) : _buildMatch(ex),
                  ),
                ),
              ),
              const SizedBox(height: 16),
